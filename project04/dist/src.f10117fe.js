...
var UserList = function (_super) {
  ...
  UserList.prototype.renderItem = function (model, itemParent) {
    return new UserShow_1.UserShow(itemParent, model).render();
  };
...
},{"./CollectionView":"src/views/CollectionView.ts","./UserShow":"src/views/UserShow.ts"}],"src/constants.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.usersAPI = exports.api = void 0;
exports.api = "http://localhost:3000";
exports.usersAPI = exports.api + "/users";
...
module.exports = {
  ...
  "_spec": "axios",
  "_where": "C:\\Users\\Jerem\\dev\\react\\udemy_typescript_grider\\project04",
  "author": {
    "name": "Matt Zabriskie"
  },
  "browser": {
...
var APISync = function () {
  function APISync(api) {
    this.api = api;
  }

  APISync.prototype.fetch = function (id) {
    return axios_1.default.get(this.api + "/" + id);
  };
  ...
  APISync.prototype.save = function (data) {
    ...
    if (id) {
      return axios_1.default.put(this.api + "/" + id, data);
    } else {
      return axios_1.default.post(this.api, data);
    }
  };
...
var Collection = function () {
  ...
  Collection.prototype.fetch = function () {
    ...
    axios_1.default.get(this.api).then(function (response) {
...
var User = function (_super) {
  ...
  User.buildUser = function (attrs) {
    return new User(new Attributes_1.Attributes(attrs), new Eventing_1.Eventing(), new APISync_1.APISync(constants_1.usersAPI));
  };

  User.buildUserCollection = function () {
    return new Collection_1.Collection(constants_1.usersAPI, function (json) {
...
exports.User = User;
},{"../constants":"src/constants.ts","./Model":"src/models/Model.ts","./Attributes":"src/models/Attributes.ts","./Eventing":"src/models/Eventing.ts","./APISync":"src/models/APISync.ts","./Collection":"src/models/Collection.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
if (app) {
  var userCollection_1 = new Collection_1.Collection(constants_1.usersAPI, function (json) {
    return User_1.User.buildUser(json);
  });
  userCollection_1.on('change', function () {
    var usersList = new UserList_1.UserList(app, userCollection_1);
    usersList.render();
  });
  userCollection_1.fetch();
  var usersList = new UserList_1.UserList(app, userCollection_1);
  usersList.render();
} else {
  throw new Error('App element in not found');
}
},{"./views/UserList":"src/views/UserList.ts","./models/User":"src/models/User.ts","./models/Collection":"src/models/Collection.ts","./constants":"src/constants.ts"}],"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
